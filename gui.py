...
#def Start(AccName, AccID, AccBalance)
...
# img = tk.PhotoImage(file="C:Users\\mbkap\\Desktop\\bank\\banka.png")
...
def registerScreen():
    ...
    def regDeny():
        tk.Label(registerFrame, text = "User Already exists", font = ("Goudy old style ", 15, "bold"), fg = "red", bg = framecolor).pack()
      
    def regConf():
        tk.Label(registerFrame, text = "Register Success", font = ("Goudy old style ", 15, "bold"), fg = "green", bg = framecolor).pack()
    ...
    registerButton = tk.Button(registerFrame, text = "Register", bg = framecolor, fg = "orange", font = ("Goudy old style",15), activebackground = "coral", command = registerUser)
...
def loginScreen():
    ...
    def login_success():
        tk.Label(loginFrame, text = "Login Success", font = ("Goudy old style ", 15, "bold"), fg = "lightgreen", bg = framecolor).pack()
        
        
        
    def password_not_recognized():
        message = tk.Label(loginFrame, text = "Incorrect Password", font = ("Goudy old style ", 15, "bold"), fg = "red", bg = framecolor).pack()
        
        
    def user_not_found():
        message = tk.Label(loginFrame, text = "User Not Found", font = ("Goudy old style ", 15, "bold"), fg = "red", bg = framecolor).pack()
    ...
    def loginUser():
        ...
        def withdrawConfirmation():  
                        ...
                        def withdraw_success():
                            tk.Label(withdrawFrame, text = "CONFIRM", font = ("Goudy old style ", 15, "bold"), fg = "lightgreen", bg = framecolor).pack()
                            
                            
                            
                        def withdraw_deny():
                            tk.Label(withdrawFrame, text = "DENY", font = ("Goudy old style ", 15, "bold"), fg = "red", bg = framecolor).pack()
                        ...
                        tk.Label(withdrawFrame, text = "Amount", font = ("Goudy old style ", 15, "bold"), fg = "orange", bg = framecolor).pack()
                        ...
                        def withdraw():
                            ...
                            if int(balance) < amount:
                                ...
                                withdraw_success()
                                    ...
                                    #WITHDRAW BUTTON 2
                        withDrawConf = tk.Button(withdrawFrame, text = "Withdraw", bg = framecolor, fg = "orange", font = ("Goudy old style",15), activebackground = "coral", command = withdraw)
            ...
            if verifyPassw in confirm:
                ...
                def main():
                    ...
                    def AccInfoPrinter():
                            ...
                            tk.Label(info, text = "Account: " + verifyUserName +  "\n \n" + "Account ID: " + "ID" + "\n \n" + "Balance: " + currentBalance, bg = framecolor, fg = "orange", font = ("Arial",13)).pack()
                    ...
                    withdrawButton = tk.Button(root,text = "Withdraw",command = withdrawConfirmation,activeforeground = "green",activebackground = "lightgreen", width = 12, height = 4)
                    ...
                    depositButton = tk.Button(root,text = "Deposit",command = depositConfirmation,activeforeground = "green",activebackground = "lightgreen", width = 12, height = 4)
    ...
    loginButton = tk.Button(loginFrame,text = "Login", bg = framecolor, fg = "orange", font = ("Goudy old style",15), activebackground = "coral", command = loginUser)
...
def welcome():
        ...
        tk.Label(welcome, text = "Welcome Dear Guest", bg = framecolor, fg = "pink", font = ("Arial",20)).pack()
...
loginButton = tk.Button(window,text = "Login",command = loginScreen,activeforeground = "green",activebackground = "lightgreen", width = 12, height = 4)
loginButton.grid(row = 1, column = 1)  
       
       
registerButton = tk.Button(window,text = "Register",command = registerScreen,activeforeground = "green",activebackground = "lightgreen", width = 12, height = 4)
